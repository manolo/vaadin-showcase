package com.vaadin.showcase.views.adresses;
...
import com.vaadin.showcase.data.entity.SampleAddress;
import com.vaadin.showcase.data.service.SampleAddressService;
...
@PageTitle("Adresses")
@Route(value = "adresses/:sampleAddressID?/:action?(edit)", layout = MainLayout.class)
@PermitAll
public class AdressesView extends Div implements BeforeEnterObserver {

    private final String SAMPLEADDRESS_ID = "sampleAddressID";
    private final String SAMPLEADDRESS_EDIT_ROUTE_TEMPLATE = "adresses/%s/edit";
    ...
    @Autowired
    public AdressesView(SampleAddressService sampleAddressService) {
        this.sampleAddressService = sampleAddressService;
        addClassNames("adresses-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AdressesView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleAddressId.isPresent()) {
            ...
            if (sampleAddressFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AdressesView.class);
            }
        }
    }
