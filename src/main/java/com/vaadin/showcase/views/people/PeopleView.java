package com.vaadin.showcase.views.people;
...
import com.vaadin.showcase.data.entity.SamplePerson;
import com.vaadin.showcase.data.service.SamplePersonService;
...
@PageTitle("People")
@Route(value = "people/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
...
public class PeopleView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "people/%s/edit";
