package com.vaadin.showcase.views;
...
import com.vaadin.showcase.data.entity.User;
import com.vaadin.showcase.security.AuthenticatedUser;
import com.vaadin.showcase.views.adresses.AdressesView;
import com.vaadin.showcase.views.books.BooksView;
import com.vaadin.showcase.views.chat.ChatView;
import com.vaadin.showcase.views.clients.ClientsView;
import com.vaadin.showcase.views.graphics.GraphicsView;
import com.vaadin.showcase.views.map.MapView;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Clients", "la la-th", ClientsView.class), //

                new MenuItemInfo("Map", "la la-map", MapView.class), //

                new MenuItemInfo("Chat", "la la-comments", ChatView.class), //

                new MenuItemInfo("Templates", "la la-edit", TemplatesView.class), //

                new MenuItemInfo("Pictures", "la la-th-list", PicturesView.class), //

                new MenuItemInfo("Graphics", "la la-chart-area", GraphicsView.class), //

                new MenuItemInfo("Payment", "la la-credit-card", PaymentView.class), //
