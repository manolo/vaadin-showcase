package com.vaadin.showcase.views.graphics;
...
import com.vaadin.showcase.views.graphics.ServiceHealth.Status;
import javax.annotation.security.PermitAll;

@PageTitle("Graphics")
@Route(value = "graphics", layout = MainLayout.class)
@PermitAll
public class GraphicsView extends Main {

    public GraphicsView() {
        addClassName("graphics-view");
